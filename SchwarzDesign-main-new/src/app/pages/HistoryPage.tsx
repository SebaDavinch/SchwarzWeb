...
import schwarz1 from "figma:asset/4b444414a3638aab79b1f701e0b8f1f01e76ffb7.png";
import schwarz2 from "figma:asset/8e0cd995b3711fe37c29b923f172ccbe6cfbb3ea.png";
import schwarz3 from "figma:asset/47d1fbb8f07905e83b1b495c388cd68b53101669.png";
import akihiroFibAnnounce from "figma:asset/350a43fecb21fa2eb84d2d2ff7bd9b08bca41b83.png";
import akihiroFarewellFull from "figma:asset/bd27fb81a8aaea1748ebc543ecf56dfab30cbedf.png";
...
const leaderships: Leadership[] = [
  {
    ...
    fullDesc: [
      "Madara Schwarz получил пост лидера LSPD — полиции Лс-Сант��са на сервере Harmony. Первый опыт семьи в управлении силовой фракцией на этом сервере.",
  ...
  },
  {
    ...
    video: null,
    shortDesc:
      "Roman Schwarz стал первым директором FIB из Schwarz. Первый опыт семьи в управлении федеральной структурой.",
    fullDesc: [
  ...
  },
  {
    ...
    hideScreenshot: true,
    shortDesc:
      "Akihiro Schwarz занял пост шерифа. Три месяца работы в округе.",
    fullDesc: [
      "Akihiro Schwarz стал шерифом округа Лос-Сантос, контролируя Blaine County, Paleto Bay и прилегающие территории.",
      "За три месяца LSSD был приведён в порядок: выстроены патрульные маршруты, налажена координация с другими фркциями, проведена кадровая работа.",
  ...
  },
  {
    ...
    fullDesc: [
      "Akihiro Schwarz вернулся на пост директора FIB. Два с половиной месяца стабильной работы.",
      "Налаженные процессы, развитие внутренних систем фракции. Второй срок Schwarz в FIB.",
    ...
    <div className="pt-16">
      ...
      <div className="relative h-[50vh] min-h-[400px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4">
          ...
          >
            LSPD, FIB, LSSD, Yakuza — 15 сроков лидерок суммарно на Harmony. Ниже — пять из них с подробностями.
          </motion.p>
      ...
      <section className="py-16 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          >
            {[
              { value: "15", label: "Лидерских сроков", color: "#9b2335" },
              { value: "5", label: "Лидерских постов", color: "#ff3366" },
              { value: "4", label: "Фракции", color: "#f59e0b" },
              { value: "Harmony", label: "Сервер", color: "#a78bfa" },
            ].map((s, i) => (
              <motion.div
                key={s.label}
