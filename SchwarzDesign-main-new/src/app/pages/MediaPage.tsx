...
const TELEGRAM_URL = "https://t.me/nebesnyioff";
...
const highlights = [
  {
    ...
    color: "#9b2335",
    desc: "Основатель Семьи Schwarz Family на Majestic RP Seattle",
  },
  {
    icon: Tv,
    label: "Twitch",
    ...
    <div className="pt-16">
      ...
      <div className="relative h-[55vh] min-h-[420px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4">
          ...
          >
            Основатель Семьи Schwarz Family на Majestic RP Seattle
          </motion.p>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <motion.div
              ...
              style={{
                background:
                  "linear-gradient(to right, transparent, rgba(38,165,222,0.2), transparent)",
              }}
            />

            {/* Section header */}
            <div className="flex items-center gap-4 mb-8">
              <div className="w-10 h-10 rounded-full flex items-center justify-center bg-[#26a5de]/10 border border-[#26a5de]/25">
                <Send size={18} className="text-[#26a5de]" />
              </div>
              <div className="flex-1">
                <h2
                  className="font-['Russo_One'] text-white"
                ...
                <p
                  className="font-['Oswald'] text-[#26a5de]/40 uppercase tracking-widest mt-0.5"
                  style={{ fontSize: "0.6rem" }}
                >
                  Telegram Channel
                </p>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="block border border-[#26a5de]/10 overflow-hidden group hover:border-[#26a5de]/30 transition-all duration-500"
            >
              <div
                className="h-[2px]"
                style={{
                  background:
                    "linear-gradient(to right, transparent, rgba(38,165,222,0.4), transparent)",
                }}
              />
              <div className="bg-[#0d0d14] px-6 py-10 flex items-center gap-6">
                {/* Icon circle */}
                <div className="w-16 h-16 rounded-full border border-[#26a5de]/15 group-hover:border-[#26a5de]/40 flex items-center justify-center shrink-0 transition-all duration-500 group-hover:scale-110">
                  <Send size={26} className="text-[#26a5de]/50 group-hover:text-[#26a5de] transition-colors duration-500" />
                </div>
                <div className="flex-1 min-w-0">
                  <p
                    className="font-['Russo_One'] text-white/80 group-hover:text-white transition-colors duration-300"
                  ...
                  >
                    Новости, анонсы стримов и закулисье Schwarz Family — всё в одном канале
                  </p>
                  <span
                    className="inline-flex items-center gap-2 mt-3 font-['Oswald'] text-[#26a5de]/60 uppercase tracking-widest group-hover:text-[#26a5de] transition-colors duration-300"
                    style={{ fontSize: "0.65rem" }}
                  >
                    Перейти в Telegram
