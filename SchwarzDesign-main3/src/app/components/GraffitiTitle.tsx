  ...
  return (
    <div className="relative flex flex-col items-center justify-center select-none">
      ...
      >
        {/* Shadow layer */}
        <span
          className="absolute top-1 left-1 font-['Metal_Mania'] text-black/40"
        ...
        <GlitchText
          as="h1"
          className="font-['Metal_Mania'] bg-gradient-to-b from-[#9b2335] via-[#9b2335] to-[#7a1c2a] bg-clip-text text-transparent relative"
          style={{
      ...
      >
        <span
          className="font-['Metal_Mania'] text-[#ff3366] tracking-[0.3em] uppercase"
          style={{
