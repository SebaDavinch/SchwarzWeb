...
import { Tv, ExternalLink, Radio, Eye, Music } from "lucide-react";
    ...
    <div className="flex items-center gap-3 flex-wrap justify-center">
      ...
      {isLive && (
        <motion.a
          ...
          className="inline-flex items-center gap-3 px-5 py-2.5 bg-[#9146ff]/15 border border-[#9146ff]/30 hover:bg-[#9146ff]/25 hover:border-[#9146ff]/50 transition-all duration-300 group backdrop-blur-sm"
          style={{ boxShadow: "0 0 20px rgba(145,70,255,0.15), inset 0 0 20px rgba(145,70,255,0.05)" }}
        >
          {/* Pulsing live dot */}
          <span className="relative flex h-3 w-3">
            <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-red-500 opacity-75" />
            <span className="relative inline-flex rounded-full h-3 w-3 bg-red-500" style={{ boxShadow: "0 0 8px rgba(239,68,68,0.6)" }} />
          </span>
          <span
            className="font-['Russo_One'] text-red-400 uppercase"
            style={{ fontSize: "0.7rem", textShadow: "0 0 10px rgba(239,68,68,0.4)" }}
          >
            LIVE
          </span>
          <span className="w-[1px] h-4 bg-[#9146ff]/30" />
          <Tv size={14} className="text-[#9146ff] group-hover:text-[#c084fc] transition-colors" style={{ filter: "drop-shadow(0 0 6px rgba(145,70,255,0.5))" }} />
          <span
            className="font-['Oswald'] text-[#c084fc]/90 uppercase tracking-wider"
      ...
      <motion.a
        ...
        className="inline-flex items-center gap-2.5 px-5 py-2.5 bg-white/[0.04] border border-white/10 hover:bg-white/[0.08] hover:border-white/20 transition-all duration-300 group backdrop-blur-sm"
      >
        <Music size={14} className="text-[#ff2d55] group-hover:text-[#ff6b8a] transition-colors" style={{ filter: "drop-shadow(0 0 6px rgba(255,45,85,0.4))" }} />
        <span
          className="font-['Oswald'] text-white/60 group-hover:text-white/80 uppercase tracking-wider transition-colors"
          style={{ fontSize: "0.65rem" }}
        >
          TikTok
        </span>
