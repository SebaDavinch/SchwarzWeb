...
export function HeroSection() {
  ...
  const tagline = getPageOverride("home", "hero_tagline") ?? "Опыт. Контент. Команда.";
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4">
        ...
        >
          <a
            href="#about"
            className="inline-flex items-center gap-2 px-8 py-3 border border-[#9b2335]/30 text-[#9b2335] font-['Oswald'] uppercase tracking-[0.2em] hover:bg-[#9b2335]/10 transition-all duration-300"
